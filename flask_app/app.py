...
# new code
# mlflow models export -m "models:/my_model/Production" -d models/model
...
if __name__ == "__main__":
    app.run(debug=True, host="0.0.0.0") # host="0.0.0.0" is added so that we can access this application from outside docker image also